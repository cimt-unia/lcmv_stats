...
def compute_zscored_spectrogram(
    ...
    """
    Compute a Z-scored spectrogram for a single epoch.
    ...
    Args:
        ...
        baseline_duration: Duration of baseline for Z-scoring (None = entire pre-event).
